                            ...
                            <div class="table-responsive">
                                <table class="table table-shopping">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="(link, index) in linksLoad" :key="index">
                                            ...
                                            <td>
                                                <span style="color:green" v-if="!link.status">Active</span>
                                                <span style="color:red" v-if="link.status">Deactivate</span>
                                            </td>
                                            <td>
                                                {{ link.click }}
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    <button href="#pablo" class="dropdown-toggle btn btn-primary btn-round btn-sm" data-toggle="dropdown" aria-expanded="false">Action <b class="caret"></b><div class="ripple-container"></div></button>
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a v-if="link.status" @click="activateSingleLink(link)">Activate</a></li>
                                                        <li><a v-if="!link.status" @click="deactivateSingleLink(link)">Deactivate</a></li>
                                                        <li><a :href=" link.short_link " v-if="!link.status" target="_blanck">Preview</a></li>
                                                        <li>
                                                            <router-link :to="{ name : 'stat', params : { id : link.id } }">
                                                                Stats
                                                            </router-link>
                                                        ...
                                                        <li class="divider"></li>
                                                        <li><a @click="deleteLink(link)">Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
...
export default {
    ...
    methods: {
        ...
        activateSingleLink: async function(link){
            if(!window.confirm(`Are you sure you want to activate this link`)){
                    return;
            }
            this.loader = true;
            try {
